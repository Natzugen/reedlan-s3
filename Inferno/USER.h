...
#define GCPKLevelSend	               ((void(*) (DWORD,int)) 0x005514C0)
#define gObjAddMonster					((int(*)(unsigned char))0x005B22A0)
#define GCLevelUpMsgSend				((void(*)(int, unsigned char)) 0x00551040)
...
#define gObjSetMonster					((void(*)(int,int))0x005B0AC0)
#define gObjMonsterCall					((int(*)(DWORD Index, DWORD MonsterID, DWORD X, DWORD Y)) 0x005DD5C0)
#define gObjLifeCheck					((void(*) (OBJECTSTRUCT* lpTargetObj, OBJECTSTRUCT* lpObj, int AttackDamage, int DamageSendType, int MSBFlag, int MSBDamage, BYTE Skill, int iShieldDamage)) 0x005BD7E0)
#define LogAddFuncColor					((void(*) (int, char*)) 0x005148F0)
#define gObjMissCheck					((void(*) ( OBJECTSTRUCT* lpObj, OBJECTSTRUCT* lpTargetObj, int skill, int skillSuccess, int magicsend, BOOL& bAllMiss)) 0x0053A7C0)
#define gObjAttack                      ((void(*)(OBJECTSTRUCT*,OBJECTSTRUCT*,class CMagicInf *magic,int,unsigned char,int,int)) 0x005BC490)
...
#define SHOP_SIZE				0x56C4
#define SLOT_EMPTY				-1
#define MAX_ZEN					2000000000
#define gObjZen					0xD8
#define MIN_PLAYERID	8400
...
#define GCStateInfoSend	((void(*)(OBJECTSTRUCT *gObj, BYTE State, BYTE ViewSkillState)) 0x00568490 )
...
#define DataSendS ((void(*)(PBYTE Packet,DWORD Size)) 0x005EB7F0)
...
// Offtrade
//------------------------------------------------------------------------------
#define gObjDel	((void(*) (int)) 0x005B2C10)
...
//#define GCMagicAttackNumberSend ((void(*)(int aIndex, BYTE MagicNumber, int usernumber, unsigned char skillsuccess)) 0x00568060)//??
//00541A90
//#define UseSkill ((void(*)(int aIndex, int lpMagic, BYTE x, BYTE y, BYTE dir, BYTE TargetPos, int aTargetIndex)) 0x00541A90)
...
#define GCActionSend     ((void(*) (OBJECTSTRUCT* lpObj, BYTE ActionNumber, int aIndex, int aTargetIndex)) 0x005678A0)
#define gObjAddMsgSendDelay ((void(*)  (LPOBJ lpObj, int aMsgCode, int aIndex, int delay, int SubCode))0x005B4CF0)
#define gObjAddAttackProcMsgSendDelay ((void(*)(OBJECTSTRUCT* lpObj, int aMsgCode, int aIndex, int delay, int SubCode, int SubCode2))0x005B4FB0)
#define UseSkill  ((void(*)(int aIndex, CMagicInf * lpMagic, BYTE x, BYTE y, BYTE dir, BYTE TargetPos, int aTargetIndex))0x00541A90)
#define SkillDarkHorseAttack ((BOOL(*) (int aIndex, int aTargetIndex, CMagicInf * lpMagic)) 0x00546670)
#define gObjStateAttackProc ((void(*) (OBJECTSTRUCT* gObj,int aMsgCode, int aIndex, int SubCode, int SubCode2 )) 0x0050C620)
#define GCMagicAttackNew ((void(*) (OBJECTSTRUCT* gObj,int MagicNumber, int usernumber,  BYTE skillsuccess)) 0x00568060)
#define CGBeattackRecv  ((void(*) (BYTE lpRecv, int aIndex, int magic_send)) 0x00568F80)
//#define GCLevelUpMsgSend ((void(*)(int, unsigned char)) 000551040)
#define MAKE_NUMBERW(x,y)  ( (WORD)(((BYTE)((y)&0xFF)) |   ((BYTE)((x)&0xFF)<<8 ))  )
#define CGPShopAnsBuyItem  ((void(*)(int aSourceIndex, int aTargetIndex, int iItemPos, BYTE btResult)) 0x0055FCC0)
...
extern GOBJSKILLSTRUCT gObjSkillStruct[9000];
class CMagicInf
{
public:
...
extern  LPGOBJITEMSTRUCT ItemAttribute[8192];
struct OBJECTSTRUCT 
{
...
char MSGRes7[50];
char CPUIDSerial[10];
}; extern LCTEAMGLOBAL GLOBAL;
struct QuestionStruct
{
int iInexQuest;
int HaweAnswer;
};  extern QuestionStruct QuestionStr;
